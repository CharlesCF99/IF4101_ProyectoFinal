<%@ page title="" language="C#" masterpagefile="~/Site.Master" autoeventwireup="true" codebehind="_AdminOrderStatusView.aspx.cs" inherits="IF4101_ProyectoFinal.Views._AdminOrdersControl" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-bg col-md-8 col-md-offset-2">
        <h1 align="justify">Estados de las órdenes</h1>
        <div class="row">
